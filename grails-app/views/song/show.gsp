            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="song.body.label" default="Body" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: songInstance, field: "body")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="song.dateCreated.label" default="Date Created" /></td>
                            
                            <td valign="top" class="value"><g:formatDate date="${songInstance?.dateCreated}" /></td>
